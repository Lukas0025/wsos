...
final class baseTest extends TestCase
{
    ...
    {
        $val = new \wsos\database\types\base("hello");
        $this->assertFalse(is_null($val->value));
    }

    public function testEQ(): void
    {
        $idA = new \wsos\database\types\base("2c95396c-60d6-43eb-b40f-9cdf8ff9b1fc");
        $idB = new \wsos\database\types\base("72fdd228-e996-490c-8649-f252cedac1fd");
        $idC = new \wsos\database\types\base("72fdd228-e996-490c-8649-f252cedac1fd");
    ...
    {
        $a = new \wsos\database\types\base("2c95396c-60d6-43eb-b40f-9cdf8ff9b1fc");
